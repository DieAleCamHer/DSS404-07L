...
<body>
    ...
    //Si se ha llamado esta pagina desde el formulario para modificar libros 
    //ejecutar primero la actualizacion del registro
    if (isset($_POST['guardar'])) {
        // Creando variables locales con los datos enviados desde el formulario de modifiacion
